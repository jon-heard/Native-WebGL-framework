...
bin/app.exe: obj/pc/main.o obj/pc/shaders.o obj/pc/errorHandling.o
	g++ obj/pc/main.o obj/pc/shaders.o obj/pc/errorHandling.o -o bin/app.exe -L libs/glfw/lib -L libs/glew/lib -lglew32s -lglfw3 -lopengl32 -lgdi32

obj/pc/main.o: src/main.cpp
	g++ -c src/main.cpp -o obj/pc/main.o -I libs/glfw/include -I libs/glew/include
...
bin/app.js: obj/web/main.bc obj/web/shaders.bc obj/web/errorHandling.bc
	call em++ obj/web/main.bc obj/web/shaders.bc obj/web/errorHandling.bc -o bin/app.js -lglew -s USE_GLFW=3
...
web:
	call em++ src/main.cpp src/shaders.cpp src/errorHandling.cpp -o bin/app.js -s USE_GLFW=3
