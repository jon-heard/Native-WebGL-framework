...
obj/main.o: src/main.cpp
	g++ -c src/main.cpp -o obj/main.o -I libs/glfw/include -I libs/glew/include

obj/shaders.o: src/shaders.cpp
	g++ -c src/shaders.cpp -o obj/shaders.o -I libs/glew/include

obj/errorHandling.o: src/errorHandling.cpp
	g++ -c src/errorHandling.cpp -o obj/errorHandling.o
